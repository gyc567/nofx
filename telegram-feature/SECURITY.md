...
Monnaire Trading Agent OS is an AI-powered trading system that handles real funds and API credentials. We take security seriously and appreciate the security community's efforts to responsibly disclose vulnerabilities.
...
If you discover a security vulnerability in Monnaire Trading Agent OS, please **DO NOT**:
...
To keep your Monnaire Trading Agent OS deployment secure:
...
# Watch GitHub releases: https://github.com/gyc567/nofx/releases
```
...
**Thank you for helping keep Monnaire Trading Agent OS secure!** 🔒
...
Monnaire Trading Agent OS 是一个处理真实资金和 API 凭证的 AI 交易系统。我们非常重视安全，并感谢安全社区负责任地披露漏洞的努力。
...
如果您在 Monnaire Trading Agent OS 中发现安全漏洞，请**不要**：
- ❌ 公开创建 GitHub Issue
...
保护您的 Monnaire Trading Agent OS 部署安全：
...
# 订阅安全公告
# 关注 GitHub 发布：https://github.com/gyc567/nofx/releases
```
...
**感谢您帮助保持 Monnaire Trading Agent OS 的安全！** 🔒
