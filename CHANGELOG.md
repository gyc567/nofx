...
All notable changes to the Monnaire Trading Agent OS project will be documented in this file.
...
This is a **major breaking update** that completely transforms Monnaire Trading Agent OS from a static config-based system to a modern web-based trading platform.
...
- [GitHub Repository](https://github.com/gyc567/nofx)
